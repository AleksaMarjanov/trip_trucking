    ...
    return (
        ...
        >
            <motion.div
                ...
                className="w-full relative z-[0] h-[80vh] md:h-[95vh] flex flex-col items-start justify-start object-cover object-center" >
                <Image
                    src={src}
                    alt="hero"
                    fill
                ...
                <motion.div
                    variants={textVariant(0.5)}
                    className="absolute bottom-[3%] md:bottom-[10%] left-[40%] sm:left-[45%] md:left-[45%] z-[30] mt-64 md:mt-[3rem] flex items-center justify-center"
