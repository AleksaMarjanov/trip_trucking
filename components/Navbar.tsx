...
const Navbar = ({ isOpen, setIsOpen }: any) => {
    ...
    return (
        <header className={`${navbar ? 'bg-white text-black  bg-opacity-50 shadow-xl py-8' : 'text-white bg-black py-12'} top-0 fixed w-full items-end justify-end z-[999] flex lg:px-16 font-normal`}>
