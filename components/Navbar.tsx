            ...
            {/* </div> */}
            {
                isOpen && (
                    <motion.nav
                        ...
                        whileInView="show"
                        viewport={{ once: true }}
                        className={`${navbar ? 'top-[10%] drop-shadow-2xl bg-black !opacity-[90%]' : 'top-[12%]'} w-[80%] flex-shrink-0 lg:hidden rounded-2xl fixed bottom-30 right-5 h-[80vh] flex flex-col text-black bg-white text-4xl font-medium`}>
