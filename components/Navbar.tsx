...
const Navbar = () => {
    ...
    return (
        <header className={`${navbar ? 'bg-white text-black py-2 shadow-xl ' : 'text-white bg-transparent'} fixed w-full items-end justify-end z-[999] flex lg:px-16 py-12 font-normal`}>
            ...
            {/* </div> */}
            {
                isOpen && (
                    <motion.nav
                        ...
                        whileInView="show"
                        viewport={{ once: true }}
                        className="w-full lg:hidden fixed top-[7%] bottom-30 left-0 py-2 h-screen flex flex-col text-black bg-white text-4xl font-medium">
